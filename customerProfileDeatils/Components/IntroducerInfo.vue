      ...
      <v-card-text>
        <v-row>
          <v-col cols="12" sm="6" md="4">
            <v-autocomplete
              ...
              v-model="customerprofiledata.Obj_Customer_Introducer.introducer_type"
          ...
          <v-col
            ...
            sm="6"
            md="4"
            v-if="customerprofiledata.Obj_Customer_Introducer.introducer_type == '01'"
          >
            <v-text-field
              v-bind="attrs"
              v-on="on"
              label="Introducer Acc Branch"
              v-model="customerprofiledata.Obj_Customer_Introducer.introducer_account_br"
            >
            </v-text-field>
          </v-col>
          <v-col
            ...
            <v-tooltip top nudge-bottom="30" nudge-right="50">
              <template v-slot:activator="{ on, attrs }">
                <v-text-field
                  ...
                  v-model="customerprofiledata.Obj_Customer_Introducer.introducer_account_no"
        ...
        <v-row>
          <v-col
            ...
            sm="6"
            md="4"
            v-if="customerprofiledata.Obj_Customer_Introducer.introducer_type == '02'"
          >
            <v-tooltip top nudge-bottom="30" nudge-right="50">
              <template v-slot:activator="{ on, attrs }">
                <v-text-field
                  ...
                  v-model="customerprofiledata.Obj_Customer_Introducer.employee_id"
          ...
          >
            <v-text-field
              ...
              v-model="customerprofiledata.Obj_Customer_Introducer.employee_pa_no"
            >
            </v-text-field>
          </v-col>
          <v-col cols="12" sm="6" md="4">
            <v-tooltip top nudge-bottom="30" nudge-right="50">
              <template v-slot:activator="{ on, attrs }">
                <v-text-field
                  ...
                  v-model="customerprofiledata.Obj_Customer_Introducer.introducer_details"
        ...
        <!-- <v-row>
          <v-col cols="12" md="12">
            <v-data-table
              item-key="customerprofiledata.Obj_Customer_Introducer.customer_id"
              items="customerprofiledata.Obj_Customer_Introducer"
              single-select
              :items-per-page="10"
              class="elevation-1"
              dense
