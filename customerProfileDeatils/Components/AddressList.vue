...
<br/>
        ...
        <v-row>
          <v-col cols="12" md="12">
            <!-- <v-data-table
              item-key="customerprofiledata.customer_id"
...
import { commonConfig } from "@../../../src/components/js/ApiLib";
//import { commonConfig } from "../../../components/js/ApiLib";
//import {  ConfigParameterAPI,  CoreCustomerAPI,} from "../../../../public/config.js";
import {
  ConfigParameterAPI,
  CoreCustomerAPI,
...
btnremove:"remove",
    ...
    addToList() {
      ...
      if (this.addressTypeExists) {
        if (this.edit) {
          ...
          this.customerprofiledata.List_Customer_Address.splice(
            addressIndex,
            1,
            data_object
          );
  ...
  computed: {
    isRefresh() {
      return this.$store.state.customer.isRefresh;
    },
    customerprofiledata: {
      get() {
